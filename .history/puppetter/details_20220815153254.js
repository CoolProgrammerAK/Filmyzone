...
async function extractedEvaluateCall(page) {
  return page.evaluate(() => {
    ...
    let category =
      element.children[1].children[0].children[0].children[0].innerText;
    let heading =
      element.children[1].children[0].children[0].children[1].innerText;
    let time =
      element.children[1].children[0].children[0].children[2].innerText;
    let desc =
      element.children[1].children[0].children[1].children[2].children[0]
        .innerText;
    let title =
      element.children[1].children[0].children[1].children[2].children[2]
        .innerText;
    let photo =
      element.children[1].children[0].children[1].children[2].children[2]
        .children[0].srcset;
    let language =
      element.children[1].children[0].children[1].children[2].children[3].innerText.replace(
        "Language: ",
        ""
      );
    let size =
      element.children[1].children[0].children[1].children[2].children[4].innerText.replace(
        "Size: ",
        ""
      );
    let quality =
      element.children[1].children[0].children[1].children[2].children[5].innerText.replace(
        "Quality: ",
        ""
      );
    let genre =
