...
async function extractedEvaluateCall(page) {
  return page.evaluate(() => {
    ...
    {download_link && review_default = element.children[0].children[0].children[1].children[2].children[11].innerText;}
    {download_link && review_heading = element.children[0].children[0].children[1].children[2].children[11].innerText;}
    {download_link && review_details = element.children[0].children[0].children[1].children[2].children[11].innerText;}
    review_heading =
