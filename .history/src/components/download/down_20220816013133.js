            ...
            <Col lg="8">
              ...
              >
                ...
                <div className="text-center my-3">
                  ...
                  <p><span id="para" className="mt-3">  <a style={{textDecoration
                        :'underline'}} onClick={()=>showtoast("Downloading started",true)}  href={this.state.data.link} download>
                        Click the following link</a> to download movie</span></p><p>
                        <span id="para" className="mt-3">  <a style={{textDecoration
                        :'underline'}} href={this.state.data.gdrive} >
                        Google Drive link</a> to download movie</span></p>
