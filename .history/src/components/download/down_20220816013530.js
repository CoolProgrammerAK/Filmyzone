      ...
      return (
        <>
          <Container className="mb-5 p-0" fluid>
            ...
            <Row style={{}}>
              <Col lg="8">
                <Container fluid className="my-1 p-0" style={{}}>
                  <div
                    style={{
                ...
                >
                  ...
                  <div className="text-center my-3">
                    ...
                    <p>
                      <span id="para" className="mt-3">
                        {" "}
                        <a
                          style={{ textDecoration: "underline" }}
                          onClick={() => showtoast("Downloading started", true)}
                    ...
                    <p className="mt-3">
                      ...
                      {this.props.match.params.fname != "none" ? (
                        ...
                        <span id="para">
                          {" "}
                          Your Requested Movie Has not Been Released yet online.
                          Please Try To Download Another Movie
                        </span>
                      )}
                    </p>
                    <div>
                    ...
                    {this.props.match.params.fname === "none" && (
                      <p className="mt-3">
                        <span id="bigpara">
                          Full Movie Will Be Uploaded Soon
                        </span>
                        <br />
                      ...
                      <div className="my-4 px-3 py-2" id="outborder">
                        ...
                        <div>
                          <img
                            ...
                            srcSet={
                              this.state.data.ss1.includes("i1.wp.com")
                                ? this.state.data.ss1
                                : this.state.data.ss1.split("//")[0] +
                                  "//i1.wp.com/" +
                                  this.state.data.ss1.split("//")[1]
                            }
                            alt="Third slide"
                          />
                          {/* .includes("i1.wp.com") */}
                          ...
                          <img
                            className="d-block w-100 mb-4"
                            srcSet={
                              this.state.data.ss2.includes("i1.wp.com")
                                ? this.state.data.ss2
                                : this.state.data.ss2.split("//")[0] +
                                  "//i1.wp.com/" +
                                  this.state.data.ss2.split("//")[1]
                            }
                            alt="Third slide"
                          />
                          <img
                            ...
                            srcSet={
                              this.state.data.ss3.includes("i1.wp.com")
                                ? this.state.data.ss3
                                : this.state.data.ss3.split("//")[0] +
                                  "//i1.wp.com/" +
                                  this.state.data.ss3.split("//")[1]
                            }
                            alt="Third slide"
                          />
                        </div>
                ...
                >
                  <div>
                    <span style={{ color: "darkgray" }}>
                      If you have any suggestion and feedback regarding
                      Filmyzone website then sure let us know. We’ll try to
                      further optimize our site. The site is Completely secure,
