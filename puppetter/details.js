...
let get_details = async (val,url="https://123mkv.media/") => {
    ...
    async function extractedEvaluateCall(page) {
        ...
        let articles=document.querySelectorAll("#content_box .post .related-posts .clear article")
            ...
            let category=element.children[1].children[0].children[0].children[0].innerText
            let heading=element.children[1].children[0].children[0].children[1].innerText
